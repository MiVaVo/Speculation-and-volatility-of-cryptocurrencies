...
def load_data_from_poloniex():
    '''
    Loads and saves prices of cryptocurrencies data from poloniex marketplace
    '''
    ...
    btc_usd_datasets = pd.read_csv(configs.datasets_created_python + '/' + 'df_to_regress.csv', index_col=0)
    ...
    bitcoin = pd.read_csv(configs.datasets_created_python + '/' + 'btc_quandl.csv', index_col=0).reset_index()
    ...
    merged_all.to_csv(configs.datasets_created_python + '/' + 'merged_all.csv', index=False, header=True)
