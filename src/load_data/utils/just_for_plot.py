...
df_price_and_spec.columns = ['Дата', 'Спекулятивная переменная для Bitcoin', 'Курс Bitcoin',
                             'Дневная доходность Bitcoin']
...
df_price_and_spec[['Спекулятивная переменная для Bitcoin']].plot(ax=ax1, color='blue',
                                                                 label='Спекулятивная переменная для Bitcoin')
